...
class OSimStatsCorpus:
    ...
    def getStat(self, statFullName):
        ...
        for set in list(self._data.items()):                    
    ...
    def getStats(self, setGlob = "*", selectGlob = "*"):
        ...
        for setName, set in list(self._data.items()):
            if fnmatch.fnmatch(setName, setGlob):
                for category, containers in list(set.items()):
                    for container, stats in list(containers.items()):
                        for statName, stat in list(stats.items()):        
